...
gunner-console-max-radar = Радар V2
gunner-console-radar = Радар
gunner-console-ammo = Боезапас
gunner-console-no-ammo = Пусто

gunner-console-list-ammo = Боезапас: {$amount}

gunner-console-button-fire-text = Огонь
gunner-console-button-eject-text = Извлечь
gunner-console-button-chamber-text = Камера
gunner-console-button-autofire-text = Автострельба

signal-port-name-weapons-output = Порт управление
signal-port-name-weapons-output-description = Соедините выходной порт с входным портом здесь.

signal-port-name-weapons-input = Порт вооружения
...
research-technology-shuttle-grenade = Базовые кинетические снаряды
research-technology-shuttle-friendshippirate = Базовое кинетическое вооружение
