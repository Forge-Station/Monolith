...
job-description-tsf-executive-officer = Oversee law enforcement, civilians, and external legal matters for the TSF.
job-description-tsf-senior-aide = Assist command staff, coordinate administration, and keep federation operations organized.
job-description-tsf-ambassador = Represent the Federation in diplomacy and handle sensitive negotiations on its behalf.
job-description-tsf-ranger = Serve as the backbone of TSF infantry operations and carry out orders from your officers.
job-description-tsf-recruit = Learn the ropes, follow ranger and officer orders, and grow into a reliable federation soldier.
