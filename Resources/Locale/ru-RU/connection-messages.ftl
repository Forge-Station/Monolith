...
ban-banned-4 = Для разбана перейдите в Discord группу https://discord.gg/Forge-Change
...
whitelist-playtime = У вас недостаточно игрового времени для игры на этом сервере. Вам нужно как минимум {$minutes} минут игрового времени.
whitelist-player-count = В настоящее время сервер не принимает новых игроков. Пожалуйста, попробуйте позже.
whitelist-notes = У вас слишком много заметок администрации для присоединения к этому серверу. Вы можете проверить свои заметки, введя /adminremarks в чат.
whitelist-manual = Вы не в вайтлисте данного сервера.
...
ipintel-server-ratelimited = Этот сервер использует систему безопасности с внешней проверкой, которая достигла своего максимального лимита проверки. Пожалуйста, свяжитесь с администрацией сервера для получения помощи и попробуйте позже.
ipintel-unknown = Этот сервер использует систему безопасности с внешней проверкой, но произошла ошибка. Пожалуйста, свяжитесь с администрацией сервера для получения помощи.
ipintel-suspicious = Похоже, вы подключаетесь через дата-центр или VPN. По административным причинам мы не разрешаем подключения через VPN. Пожалуйста, свяжитесь с администрацией сервера, если считаете, что это ошибка.
hwid-required = Ваш клиент отказался отправить аппаратный идентификатор(HWID). Пожалуйста, свяжитесь с администрацией для дальнейшей помощи.
afk-autokick-disconnect-message = Вы были кикнуты с сервера за неактив.
