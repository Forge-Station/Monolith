...
ent-SyndiAgentPDA = медицинский ало-красный КПК
    .suffix = КПК оперативника медика Горлекса, Ядерный Оперативник
