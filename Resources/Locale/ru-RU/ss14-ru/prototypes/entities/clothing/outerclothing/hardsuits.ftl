...
ent-ClothingOuterHardsuitMedical = облегчённый скафандр парамедика
...
ent-ClothingOuterHardsuitSyndieElite = элитный скафандр Горлекса
...
ent-ClothingOuterHardsuitSyndieCommander = скафандр командира Горлекса
    .desc = Усиленная версия кроваво-красного скафандра, предназначенная для командиров оперативных отрядов Горлекса. Броня значительно усилена для ведения смертоносных боёв на передовой.
ent-ClothingOuterHardsuitJuggernaut = костюм джаггернаута Gorlex
    .desc = Костюм, созданный отделом передовых исследований и разработок компании Gorlex, обладает повышенной устойчивостью к внешнему воздействию.
...
ent-ClothingOuterHardsuitCBURN = экзокостюм отряда СпБЗ
    .desc = Легковесный но прочный экзокостюм, который используют специальные подразделения зачистки. Имеет встроенные отражающие бронеплиты и поглащающие радиацию и взрывы покрытие.
ent-ClothingOuterHardsuitERTLeader = скафандр ЛД-024
    .desc = Защитный скафандр, используемый лидерами.
ent-ClothingOuterHardsuitERTEngineer = скафандр ИНЖ-51
    .desc = Защитный скафандр, используемый инженерами.
ent-ClothingOuterHardsuitERTMedical = скафандр МЕД-48
    .desc = Защитный скафандр, используемый медиками.
ent-ClothingOuterHardsuitERTSecurity = скафандр SEC-45
    .desc = Защитный скафандр, используемый офицерами безопасности.
ent-ClothingOuterHardsuitERTJanitor = скафандр УБР-21
    .desc = Защитный скафандр, используемый уборщиками.
ent-ClothingOuterHardsuitERTChaplain = скафандр КАП-401
