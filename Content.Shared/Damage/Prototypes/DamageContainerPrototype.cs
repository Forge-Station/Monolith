...
namespace Content.Shared.Damage.Prototypes
{
    ...
    public sealed partial class DamageContainerPrototype : IPrototype
    {
        ...
        /// </summary>
        [DataField("supportedGroups", customTypeSerializer: typeof(ProtoId<DamageGroupPrototype>))]
        ...
        /// </summary>
        [DataField("supportedTypes", customTypeSerializer: typeof(ProtoId<DamageTypePrototype>))]
