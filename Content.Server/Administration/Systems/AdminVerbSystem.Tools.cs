...
public sealed partial class AdminVerbSystem
{
    ...
    [Dependency] private SharedJobSystem _jobSystem = default!; // Forge-change: _EE nationality
    ...
    private void AddTricksVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if (TryComp<MapComponent>(args.Target, out var map))
        {
            ...
            {
                if (_mapManager.IsPaused(map.MapId))
                {
                    Verb unpauseMap = new()
                    {
                        Text = "Unpause Map",
                        ...
                        Act = () =>
                        {
                            _mapManager.SetPaused(map.MapId, false);
                        },
                        Impact = LogImpact.Extreme,
                ...
                else
                {
                    Verb pauseMap = new()
                    {
                        ...
                        Act = () =>
                        {
                            _mapManager.SetPaused(map.MapId, true);
                        },
                        Impact = LogImpact.Extreme,
