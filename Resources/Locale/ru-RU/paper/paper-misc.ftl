...
book-text-holoparasite-info =
    ...
    Мы в компании Gorlex гордимся нашими передовыми военными и промышленными технологиями и очень ценим ваш вклад в наше развитие!
    ...
    Gorlex Inc. не несёт ответственности за тотальную аннигиляцию вызванную неправильным использованием технологии Голопаразита.
...
book-text-combat-bakery-kit =
    Благодарим за выбор нашего набора боевой выпечки!
    В комплект входят два запатентованных CyberSun метательных круассана и один багет-меч, заявка на патент которого ещё рассматривается.
    Приложенная машинная плата Donk Co. позволит собрать микроволновую печь, способную выпекать новое оружие.
    Как и боеприпасы из теста, эту записку после использования следует съесть. Удачи, агент.

    Рецепт багета-меча:
    Тесто - 1 шт.
    Соль - 5 ед.
    Перец - 5 ед.
    Металлический стержень - 1 шт.
    Время приготовления: 15 секунд

    Рецепт метательного круассана:
    Сырой круассан - 1 шт.
    Кусочек сливочного масла - 1 шт.
    Осколок стекла - 1 шт.
    Время приготовления: 5 секунд

book-text-cargo-instructions =
    Вы попытались запустить аппарат, не загрузив товар.

    Чтобы воспользоваться аппаратом, вручную поместите в соответствующий портовый диспенсер один из запрашиваемых материалов. Вознаграждение будет выдано на верхнюю панель аппарата.

    Грузовые ящики можно покупать и продавать в следующих местах:
    - флагман ТСФ «Гальцион» - только продажа
    - станция «Камелот» - покупка и продажа
    - Торговый центр - покупка и продажа
    - грузовые депо - покупка и продажа
    - база ФДА - только продажа
    - «Юпитер» ФДА - только продажа

    Этот лист автоматически распадётся через 2 минуты.

book-text-cargo-outage =
    Уважаемый пользователь!

    Из-за непредвиденной аномалии на торговых маршрутах поставщики грузовых автоматов не смогли пополнить запасы.

    Основные гипотезы о причине этого внезапного сбоя всё ещё проходят экспертную проверку. Пока что главным виновником считают малоизученное явление под названием «космический ветер».

    Тем временем в секторе остаются другие источники товаров: изъятие бесхозного имущества, доставка востребованных материалов заказчикам и разбор покинутых грузовых судов.

    Подробности уточняются. Благодарим за терпение.

    С вашего счёта списано 10 кредитов в качестве платы за обслуживание.
