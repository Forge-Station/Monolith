ent-WeaponLmgAR400 = NEK'o AR-400 (5.56x45 мм)
    .desc = Скорее всего, самодельная переделка пулемёта: нет сошек и цевья. Стреляйте осторожно — отдача жёсткая. Патронник под 5.56x45 мм, подходят короба и обычные магазины.
ent-WeaponLmgType99 = NEK'o Type-99 «Раскольников» (7.62x51 мм)
