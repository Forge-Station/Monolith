...
guide-entry-atmosphericupsets = Атмосферные помехи
guide-entry-spacing = Интервалы
...
guide-entry-dessert-recipes = Десерты & Выпечка
