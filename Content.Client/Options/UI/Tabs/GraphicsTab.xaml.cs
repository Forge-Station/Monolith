...
using Content.Shared._Forge.CCVars; // Forge-Change
...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        Control.AddOptionSlider(
            ForgeCCVars.ChatFontSize,
            ChatFontSizeSlider,
            ForgeUiSizing.MinFontSize,
            ForgeUiSizing.MaxFontSize,
            (_, value) => Loc.GetString("ui-options-chat-font-size-value", ("size", value)));
        Control.AddOptionSlider(
            ForgeCCVars.ExamineFontSize,
            ExamineFontSizeSlider,
            ForgeUiSizing.MinFontSize,
            ForgeUiSizing.MaxFontSize,
            (_, value) => Loc.GetString("ui-options-examine-font-size-value", ("size", value)));
        Control.AddOptionPercentSlider(
            ForgeCCVars.HudScale,
            HudScaleSlider,
            ForgeUiSizing.MinHudScale,
            ForgeUiSizing.MaxHudScale);
        Control.AddOptionPercentSlider(
            ForgeCCVars.StorageScale,
            StorageScaleSlider,
            ForgeUiSizing.MinHudScale,
            ForgeUiSizing.MaxHudScale);
        // Forge-Change-End
