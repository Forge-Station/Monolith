...
ent-MaterialSynthalloy = синталлой
    .suffix = Полный
    .desc = Экспериментальный полимер, разработанный Федерацией для применения под высокими нагрузками. Усилен наноплетением из пластали и насыщен газообразной плазмой.
...
ent-MaterialIridite = иридит
    .suffix = Полный
    .desc = Сложный сплав, синтезируемый из атмосферных газов или продвинутой металлургии; вне сектора широко используется в тяжёлой промышленности, наноматериалах и высококлассных компьютерах.
