    ...
    IComputerWindow<ShuttleBoundUserInterfaceState>
{
    ...
    private BoundUserInterface? _boundUi;
    ...
    public void BindShuttleBui(BoundUserInterface bui)
    {
        _boundUi = bui;
    }
    ...
    public void SwitchMode(ShuttleConsoleMode mode)
    {
        ...
        _boundUi?.SendMessage(new ShuttleConsoleUiTabMessage
        {
            Tab = (ShuttleConsoleUiTab)(byte)mode,
        });
    }
