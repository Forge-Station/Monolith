...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest
    {
        ...
        private static readonly ResPath[] ShuttleMapFiles = GameDataScrounger.FilesInDirectoryInVfs("/SharedMaps/_Mono/Shuttles", "*.yml")
            .Concat(GameDataScrounger.FilesInDirectoryInVfs("/SharedMaps/_Forge/Shuttles", "*.yml"))
            .ToArray();
...
#nullable disable
        ...
        public async Task NonGameMapsLoadableTest(ResPath mapPath)
        {
            ...
            // Mono
            var gameMaps = protoManager.EnumeratePrototypes<GameMapPrototype>().Select(o => o.MapPath).Where(o => o.CanonPath.Contains("_Mono")).ToHashSet();
