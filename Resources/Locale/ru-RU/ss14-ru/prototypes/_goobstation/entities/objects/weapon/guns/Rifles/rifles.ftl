...
ent-WeaponRifleBurner = CS Горелка (12.7x99мм)
    .desc = Крупнокалиберная винтовка Горлекса с патронником 12.7x99мм, способная стрелять противотанковыми и осколочно-фугасными снарядами.
...
ent-WeaponRifleVympel = PD-VI M-32 Вымпел (5.56x45mm)
    .desc = Компактная буллпап винтовка, использующая боеприпасы калибра 5.56x45мм. Барабан прорезан для глушителей, и на стволе присутствует прицельная планка для крепления прицелов.