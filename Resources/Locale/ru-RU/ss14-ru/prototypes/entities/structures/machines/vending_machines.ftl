...
ent-VendingMachineSyndieDrobe = ГорлексШкаф
    .desc = Шкаф-машина, закодированная горлексом, содержит элитную экипировку для различных операций.
...
ent-VendingMachineCentDrobe = ФлотШкаф
...
#    .desc = Надеюсь, не из свежевыжатых горлексов?
