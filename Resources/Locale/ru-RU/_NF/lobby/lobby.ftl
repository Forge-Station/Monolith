...
frontier-lobby-nfsd-description = Флагман «Халкион» — оперативный центр ТСФ. Здесь вы можете:
...
frontier-lobby-renegate-description = Аванпост восставших колоний. Здесь вы можете:
   - Служить в иерархии подчинения коммодора
...
frontier-lobby-empire-description = Имперский аванпост. Здесь вы можете:
 ...
 {"["}color=gray]Некоторые роли на этой станции [color=lightblue]доступны только по вайтлисту[/color] и требуют подачи заявки в Discord для получения доступа.[/color]
frontier-lobby-empire-secondary-subtext = Каторга и резервный аванпост СИВ 
frontier-lobby-empire-secondary-description = Вспомогательный аванпост СИВ является альтернативным резервным аванпостом на случай, если Оплот выйдет из строя. Дополнительно служит каторгой для провинившихся.
