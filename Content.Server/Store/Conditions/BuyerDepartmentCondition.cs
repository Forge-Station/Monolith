...
public sealed partial class BuyerDepartmentCondition : ListingCondition
{
    ...
    /// </summary>
    [DataField("whitelist", customTypeSerializer: typeof(ProtoId<DepartmentPrototype>))]
    public HashSet<string>? Whitelist;

    /// <summary>
    /// A blacklist of department prototypes that can purchase this listing. Only one needs to be found.
    /// </summary>
    [DataField("blacklist", customTypeSerializer: typeof(ProtoId<DepartmentPrototype>))]
