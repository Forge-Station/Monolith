...
ent-WeaponSubMachineGunFirestarter = HWM Поджигатель (.45 ACP)
    .desc = Отличный полностью автоматический ПП. Использует боеприпасы .45 ACP.
ent-WeaponSubMachineGunMalandro = RS-2 «Маландро» (9×19 мм)
    .desc = Грубый, потрёпанный пистолет-пулемёт под патрон 9×19 мм для ближнего боя. Может выпустить очередь из десяти патронов, но точность при этом заметно страдает.
ent-WeaponSubMachineGunMalandroPMC = RS-2 «Маландро» (9×19 мм) (зарегистр.)
