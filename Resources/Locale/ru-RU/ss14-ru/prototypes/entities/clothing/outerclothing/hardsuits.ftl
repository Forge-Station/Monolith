...
ent-ClothingOuterHardsuitCBURN = экзокостюм отряда СпБЗ
    .desc = Легковесный но прочный экзокостюм, который используют специальные подразделения зачистки.Имеет светоотражающие вставки для лучшей защиты от лучевого оружия.
