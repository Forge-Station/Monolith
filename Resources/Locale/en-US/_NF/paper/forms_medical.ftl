paper-content-PaperWrittenMedicalFormPatientInfo =
...
paper-content-PaperWrittenMedicalFormPrescription =
...
paper-content-PaperWrittenMedicalFormHealthInsurance =
    { "[" }color=#2EA5E6]◥[bold]N[/bold]◣ [bold]Medical Contractor Standards[/bold][/color]
    { "[" }color=#2EA5E6]‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾[/color]
...
paper-content-PaperWrittenMedicalFormServiceInvoice =
    { "[" }color=#2EA5E6]◥[bold]N[/bold]◣ [bold]Medical Contractor Standards[/bold][/color]
    { "[" }color=#2EA5E6]‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾[/color]
...
paper-content-PaperWrittenMedicalFormReceiptInvoice =
...
paper-content-PaperWrittenMedicalFormRelease =
    { "[" }color=#33ccff]◥[bold]N[/bold]◣ [bold]Director of Care Payroll[/bold][/color]
    { "[" }color=#33ccff]‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾[/color]
