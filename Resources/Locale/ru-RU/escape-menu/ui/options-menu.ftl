...
ui-options-bwoink-sound = Звук АХелпа (Бвоиньк!)
...
ui-options-ambient-occlusion = Показывать эффект затенения (Ambient Occlusion)
...
ui-options-exped-music-volume = Громкость музыки экспедиций:
ui-options-auto-fill-highlights = Автозаполнение строки статуса информацией персонажа
...
ui-options-header-text-other = Другие текстовые поля
...
ui-options-function-loadoutshift1 = Загрузка хотбара Shift+1
ui-options-function-loadoutshift2 = Загрузка хотбара Shift+2
ui-options-function-loadoutshift3 = Загрузка хотбара Shift+3
ui-options-function-loadoutshift4 = Загрузка хотбара Shift+4
ui-options-function-loadoutshift5 = Загрузка хотбара Shift+5
ui-options-function-loadoutshift6 = Загрузка хотбара Shift+6
ui-options-function-loadoutshift7 = Загрузка хотбара Shift+7
ui-options-function-loadoutshift8 = Загрузка хотбара Shift+8
ui-options-function-loadoutshift9 = Загрузка хотбара Shift+9
ui-options-function-loadoutshift0 = Загрузка хотбара Shift+0
ui-options-function-text-cursor-left = Курсор влево
ui-options-function-text-cursor-right = Курсор вправо
ui-options-function-text-cursor-up = Курсор вверх
ui-options-function-text-cursor-down = Курсор вниз
ui-options-function-text-cursor-word-left = На слово влево
ui-options-function-text-cursor-word-right = На слово вправо
ui-options-function-text-cursor-begin = В начало
ui-options-function-text-cursor-end = В конец
ui-options-function-text-cursor-select = Выделить
...
ui-options-function-text-cursor-select-word-left = Выделить слово слева
ui-options-function-text-cursor-select-word-right = Выделить слово справа
ui-options-function-text-cursor-select-begin = Выделить до начала
ui-options-function-text-cursor-select-end = Выделить до конца
...
ui-options-function-text-submit = Принять
ui-options-function-multiline-text-submit = Применить (многострочное)
...
ui-options-function-text-scroll-to-bottom = В конец списка
ui-options-function-text-tab-complete = Дополнение Tab
ui-options-function-text-complete-next = Следующий вариант
ui-options-function-text-complete-prev = Предыдущий вариант
ui-options-accessability-header-visuals = Визуальные настройки
ui-options-accessability-header-content = Настройки контента
ui-options-censor-nudity = Скрыть наготу персонажей
ui-options-admin-player-panel = Список игроков
ui-options-admin-player-tab-symbol-setting = Символы антагонистов
ui-options-admin-player-tab-symbol-setting-off = Без символа
ui-options-admin-player-tab-symbol-setting-basic = Обычный символ
ui-options-admin-player-tab-symbol-setting-specific = Специфичный символ
ui-options-admin-player-tab-role-setting = Отображение ролей
ui-options-admin-player-tab-role-setting-roletype = Тип роли
ui-options-admin-player-tab-role-setting-subtype = Подтип
ui-options-admin-player-tab-role-setting-roletypesubtype = Тип и подтип
ui-options-admin-player-tab-role-setting-subtyperoletype = Подтип и тип
ui-options-admin-player-tab-color-setting = Цвета
ui-options-admin-player-tab-color-setting-off = Без цвета
ui-options-admin-player-tab-color-setting-character = Окрашивать имена антагов
ui-options-admin-player-tab-color-setting-roletype = Окрашивать типы ролей
ui-options-admin-player-tab-color-setting-both = Оба варианта
ui-options-admin-overlay-title = Админ-наложение
...
ui-options-admin-overlay-antag-symbol = Символ антага
ui-options-admin-overlay-antag-symbol-off = Без символа
ui-options-admin-overlay-antag-symbol-basic = Обычный символ
ui-options-admin-overlay-antag-symbol-specific = Специфичный символ
