...
ent-ComputerShuttle = консоль управления шаттлом
    .desc = Используется для пилотирования корабля.
ent-ComputerShuttleSyndie = консоль управления шаттлом горлекса
    .desc = Используется для пилотирования корабля горлекса.
...
ent-SyndicateComputerComms = консоль связи Горлекса
...
ent-CentcommComputerComms = консоль связи УСФ
