...
ent-BssVoidCoordinatesDisk = диск теневых координат
    .desc = Опалённый диск с одноразовым блюспейс-вектором в затенённую систему.
ent-BssVoidCoordinatesDiskWest = диск теневых координат
    .desc = Опалённый диск с одноразовым блюспейс-вектором в затенённую систему.
    .suffix = Запад
ent-BssVoidCoordinatesDiskNorth = диск теневых координат
    .desc = Опалённый диск с одноразовым блюспейс-вектором в затенённую систему.
    .suffix = Север
ent-BssVoidCoordinatesDiskSouth = диск теневых координат
    .desc = Опалённый диск с одноразовым блюспейс-вектором в затенённую систему.
    .suffix = Юг
