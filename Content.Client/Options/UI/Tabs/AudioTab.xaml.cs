...
using Content.Shared._Forge.CCVars; // Corvax-Frontier-Barks
...
public sealed partial class AudioTab : Control
{
    ...
    public AudioTab()
    {
        ...
        // Corvax-TTS-Start
        Control.AddOptionPercentSlider(
            ForgeCCVars.TTSVolume,
            SliderVolumeTts,
            scale: ContentAudioSystem.TtsMultiplier);

        Control.AddOptionPercentSlider(
            ForgeCCVars.TTSRadioVolume,
            SliderVolumeRadioTts,
            scale: ContentAudioSystem.TtsRadioMultiplier);
        // Corvax-TTS-End

        Control.AddOptionPercentSlider(
            ForgeCCVars.BoardingTeleportVolume,
