...
public sealed partial class CCVars
{
    ...
    /// <summary>
    ///     Minimum number of tiles a grid must have to be drawn on the map.
    ...
    public static readonly CVarDef<float> EmergencyShuttleDockTime =
        CVarDef.Create("shuttle.emergency_dock_time", 465f, CVar.SERVERONLY); // Frontier: 180f<300f
    ...
    public static readonly CVarDef<int> EmergencyShuttleAutoCallTime =
        CVarDef.Create("shuttle.auto_call_time", 480, CVar.SERVERONLY); // Frontier: 90<360
