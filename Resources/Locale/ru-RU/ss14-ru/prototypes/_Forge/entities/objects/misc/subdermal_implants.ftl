...
ent-SpnTrackingImplant = имплант слежения СПН
    .desc = Этот имплант показывает местоположение носителя для сервера мониторинга СПН и оповещает о смерти в канал Союза Прогрессивных Народов.
