...
public sealed partial class SignalSwitchComponent : Component
{
    ...
    /// </summary>
    [DataField("onPort", customTypeSerializer: typeof(ProtoId<SourcePortPrototype>))]
    public string OnPort = "On";

    /// <summary>
    ///     The port that gets signaled when the switch turns off.
    /// </summary>
    [DataField("offPort", customTypeSerializer: typeof(ProtoId<SourcePortPrototype>))]
    ...
    /// </summary>
    [DataField("statusPort", customTypeSerializer: typeof(ProtoId<SourcePortPrototype>))]
