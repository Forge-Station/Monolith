...
namespace Content.Server.Tabletop
{
    ...
    public sealed partial class TabletopParchisSetup : TabletopSetup
    {
        ...
        [DataField("redPiecePrototype", customTypeSerializer:typeof(ProtoId<EntityPrototype>))]
        public string RedPiecePrototype { get; private set; } = "RedTabletopPiece";

        [DataField("greenPiecePrototype", customTypeSerializer:typeof(ProtoId<EntityPrototype>))]
        public string GreenPiecePrototype { get; private set; } = "GreenTabletopPiece";

        [DataField("yellowPiecePrototype", customTypeSerializer:typeof(ProtoId<EntityPrototype>))]
        public string YellowPiecePrototype { get; private set; } = "YellowTabletopPiece";

        [DataField("bluePiecePrototype", customTypeSerializer:typeof(ProtoId<EntityPrototype>))]
