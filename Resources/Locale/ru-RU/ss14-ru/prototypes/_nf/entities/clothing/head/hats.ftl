...
ent-ClothingHeadHatNfsdBeretGreen = берет ТСФ
    .desc = Берет помощника командующего офицера.
ent-ClothingHeadHatNfsdBeretBrown = берет ТСФ
    .desc = Берет помощника командующего офицера.
ent-ClothingHeadHatNfsdBeretCream = берет ТСФ
    .desc = Берет помощника командующего офицера.
ent-ClothingHeadHatNfsdCampaign = шляпа представителя ТСФ
    .desc = Йаа-хууу, партнёр.
ent-ClothingHeadHatNfsdCampaignFilled = шляпа представителя ТСФ
    .desc = Йаа-хууу, партнёр.
    .suffix = Заполненный
ent-ClothingHeadHatNfsdSmallCampaign = шляпа представителя ТСФ
    .desc = Йаа-хууу, партнёр.
