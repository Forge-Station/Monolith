...
namespace Content.Server.Atmos.EntitySystems
{
    public sealed partial class AtmosphereSystem
    {
        ...
        public bool ConsiderSuperconductivity(GridAtmosphereComponent gridAtmosphere, TileAtmosphere tile)
        {
            ...
            AddChunkTile(gridAtmosphere, gridAtmosphere.SuperconductivityTiles, chunk.SuperconductivityTiles, tile);
            return true;
        }
        ...
        public void FinishSuperconduction(GridAtmosphereComponent gridAtmosphere, TileAtmosphere tile, float temperature)
        {
            ...
            if (temperature < Atmospherics.MinimumTemperatureForSuperconduction)
            {
                if (TryGetChunkState(gridAtmosphere, GetAtmosChunk(tile.GridIndices), out var chunk) && chunk != null)
                    RemoveChunkTile(gridAtmosphere, gridAtmosphere.SuperconductivityTiles, chunk.SuperconductivityTiles, tile);
                else
