...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    public sealed partial class AdminbusTab : Control
    {
        ...
        private readonly MappingPaletteUIController _paletteController; // Forge-Change
        ...
        public AdminbusTab()
        {
            ...
            _paletteController = UserInterfaceManager.GetUIController<MappingPaletteUIController>(); // Forge-Change
            ...
            SpawnPaletteButton.OnPressed += SpawnPaletteButtonOnPressed; // Forge-Change
        ...
        // Forge-Change-Start
        private void SpawnPaletteButtonOnPressed(BaseButton.ButtonEventArgs obj)
        {
            _paletteController.ToggleWindow();
        }
        // Forge-Change-End
    }
}
