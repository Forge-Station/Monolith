...
sec-apartment-ui-squads-save-tooltip = Сохранить
...
sec-apartment-ui-squads-location = Примерное местоположение
...
sec-apartment-ui-timers-info = Нажмите планшетом на таймер, чтобы привязать его к этому устройству.
...
sec-apartment-timer-linked = Таймер привязан к планшету.
sec-apartment-timer-already-linked = Этот таймер уже привязан к планшету.
