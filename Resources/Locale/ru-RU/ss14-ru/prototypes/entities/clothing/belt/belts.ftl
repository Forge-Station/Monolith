...
ent-ClothingBeltSyndieHolster = плечевая кобура горлекса
...
ent-ClothingBeltMilitaryWebbingMed = армейская РПС медика
    .desc = Ременно-плечевая система тактических ремней.
ent-ClothingBeltMilitaryWebbingMedExpResist = {ent-ClothingBeltMilitaryWebbingMed}
    .desc = {ent-ClothingBeltMilitaryWebbingMed.desc}
    .suffix = защита от взрыва
