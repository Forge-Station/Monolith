...
ent-WeaponSubMachineGunFirestarter = HWM Поджигатель (.45 ACP)
    .desc = Отличный полностью автоматический ПП. Использует боеприпасы .45 ACP.
ent-WeaponSubMachineGunMalandro = RS-2 «Маландро» (4.6x30 мм)
    .desc = Грубый, потрёпанный пистолет-пулемёт под патрон 4.6x30 мм для ближнего боя. Может выпустить очередь из десяти патронов, но точность при этом заметно страдает.
ent-WeaponSubMachineGunMalandroPMC = RS-2 «Маландро» (4.6x30 мм) (зарегистр.)
