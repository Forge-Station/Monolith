...
";
    ...
    {
        public static string Tag = "StaticFieldTestTag";
    }
    ...
    {
        public static string[] Tag = ["StaticFieldTestTag", "StaticFieldTestTag"];
    }

    [Reflect(false)]
    private sealed class StringArrayInvalid
    {
        public static string[] Tag = [string.Empty, "StaticFieldTestTag", string.Empty];
    }
