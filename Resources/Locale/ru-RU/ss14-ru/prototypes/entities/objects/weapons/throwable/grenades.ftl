...
ent-GrenadeFlashEffect = { "" }
    .desc = { "" }
ent-SyndieMiniBomb = минибомба горлекса
    .desc = Взрывное устройство, производимое Горлексом, используемое, чтобы сеять хаос и разрушения.
...
ent-SyndieTrickyBomb = хитробомба горлекса
    .desc = Взрывное устройство, производимое Горлексом, используемое, чтобы отвлекать внимание.
