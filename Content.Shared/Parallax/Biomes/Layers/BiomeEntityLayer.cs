...
{
    /// <inheritdoc/>
    [DataField("allowedTiles", customTypeSerializer:typeof(ProtoId<ContentTileDefinition>))]
    ...
    [DataField("entities", required: true, customTypeSerializer: typeof(ProtoId<EntityPrototype>))]
