...
ent-PlushieNuke = плюшевый нюкер
    .desc = Мягкая игрушка, напоминающая ядерного оперативника Горлекса. На бирке указано, что оперативники это полнейшая выдумка.
...
ent-BalloonSyn = воздушный шарик горлекса
...
ent-BalloonNT = воздушный шарик Nanotrasen
    .desc = Разработан специально для причинения максимального психологического вреда оперативникам Горлекса.
